...
namespace Spotlight.Client
{
	...
	internal static class EntityDecoration
	{
	...
	internal class EntityDecorationUnregisteredPropertyException : Exception
	{
	}

	internal class EntityDecorationUndefinedTypeException : Exception
	{
	}
}